...
public class SplashActivity extends ListActivity  
{
	...
	private ItemVo[] _items = {
			new ItemVo("\"Welcome to Computer Graphics\"", ExampleRotatingPlanets.class, "ExampleRotatingPlanets.java"),
			new ItemVo("Load model kota 3D dari file .obj", ExampleLoadObjFile.class, "ExampleLoadObjFile.java"),
			new ItemVo("Load multiple models dari file .obj", ExampleLoadObjFileMultiple.class, "ExampleLoadObjFileMultiple.java"),
			new ItemVo("Load model dari file .3ds", ExampleLoad3DSFile.class, "ExampleLoad3DSFile.java"),
			new ItemVo("Load animasi dari file .md2", ExampleLoadMD2File.class, "ExampleLoadMD2File.java"),
			...
			new ItemVo("\"About Team\"", ExampleRotatingPlanets.class, "ExampleRotatingPlanets.java")
	};
    ...
    public void onCreate(Bundle savedInstanceState)
    {
	    ...
	    // TEST ONLY: digunakan untuk menjalankan langsung satu Activity tertentu, misal ExampleLoadObjFile
    	//this.startActivity( new Intent(this, ExampleLoadObjFile.class ) );
    }
